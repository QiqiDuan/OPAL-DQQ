% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% %
% Numerical Experiments of RS for Single-Objective 
...
MAX_ITER           = MAX_FUN_EVAL / POP_SIZE; % maximum of iterations
...
for fun_ind = 1 : TOTAL_NUM_FUNS
    ...
    for ind_trial = 1 : TOTAL_NUM_TRIALS
        ...
        [opt_pos(ind_trial, :), opt_val(ind_trial, 1), ...
            ...
            RS(FHD, fun_ind, FUN_DIM, SEARCH_LOWER_BOUND, SEARCH_UPPER_BOUND, ...
